...
const DESKTOP_USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.92 Safari/537.36';
...
class ReadMessagesContext extends Context {
  constructor(vk, [eventId, peerId, id]) {
    ...
    this.subTypes = [eventId === 6 ? 'read_inbox_messages' : 'read_outbox_messages'];
  }
